...
BEGIN_RECV_TABLE_NOBASE( CBaseCombatCharacterShared, DT_BaseCombatCharacterSharedLocal )
END_RECV_TABLE()

BEGIN_RECV_TABLE_NOBASE( CBaseCombatCharacterShared, DT_BaseCombatCharacterShared )
	// Local Data.
	RecvPropDataTable( "basesharedlocaldata", 0, 0, &REFERENCE_RECV_TABLE(DT_BaseCombatCharacterSharedLocal) ),
END_RECV_TABLE()

BEGIN_PREDICTION_DATA_NO_BASE( CBaseCombatCharacterShared )
END_PREDICTION_DATA()

// Server specific.
#else

BEGIN_SEND_TABLE_NOBASE( CBaseCombatCharacterShared, DT_BaseCombatCharacterSharedLocal )
END_SEND_TABLE()

BEGIN_SEND_TABLE_NOBASE( CBaseCombatCharacterShared, DT_BaseCombatCharacterShared )
	// Local Data.
	SendPropDataTable( "basesharedlocaldata", 0, &REFERENCE_SEND_TABLE( DT_BaseCombatCharacterSharedLocal ), SendProxy_SendLocalDataTable ),
END_SEND_TABLE()
...
// --------------------------------------------------------------------------------------------------- //
// Shared CBaseCombatCharacter implementation.
// --------------------------------------------------------------------------------------------------- //

// --------------------------------------------------------------------------------------------------- //
// CBaseCombatCharacterShared implementation.
// --------------------------------------------------------------------------------------------------- //

CBaseCombatCharacterShared::CBaseCombatCharacterShared()
{
}

void CBaseCombatCharacterShared::Init( CBaseCombatCharacter *pOuter )
{
	m_pOuter = pOuter;
}
