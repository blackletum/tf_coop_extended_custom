...
void UTIL_Portal_Trace_Filter( CTraceFilterSimpleClassnameList *traceFilterPortalShot )
{
	...
	traceFilterPortalShot->AddClassnameToIgnore( "tf_weapon_portalgun" );

	traceFilterPortalShot->AddClassnameToIgnore( "obj_sentrygun" );
	traceFilterPortalShot->AddClassnameToIgnore( "obj_dispenser" );
	traceFilterPortalShot->AddClassnameToIgnore( "obj_teleporter" );
	...
	traceFilterPortalShot->AddClassnameToIgnore( "npc_eli" );
	...
	traceFilterPortalShot->AddClassnameToIgnore( "npc_fastzombie_torso" );
	...
	traceFilterPortalShot->AddClassnameToIgnore( "npc_headcrab_poison" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_headcrab_black" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_antlion" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_antlionguard" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_antliongurb" );
	...
	traceFilterPortalShot->AddClassnameToIgnore( "npc_cremator" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_stalker" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_turret_ceiling" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_turret_floor" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_turret_ground" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_hunter" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_bullsquid" );
	traceFilterPortalShot->AddClassnameToIgnore( "generic_actor" );
	traceFilterPortalShot->AddClassnameToIgnore( "cyler_actor" );

	traceFilterPortalShot->AddClassnameToIgnore( "prop_combine_ball" );

	traceFilterPortalShot->AddClassnameToIgnore( "monster_scientist" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_barney" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_human_grunt" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_robo_grunt" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_alien_grunt" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_alien_slave" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_vortigaunt" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_headcrab" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_zombie" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_gonome" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_bullchicken" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_snark" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_human_assassin" );
	traceFilterPortalShot->AddClassnameToIgnore( "monster_sitting_scientist" );

	traceFilterPortalShot->AddClassnameToIgnore( "prop_vehicle_jeep" );
	traceFilterPortalShot->AddClassnameToIgnore( "prop_vehicle_airboat" );
	traceFilterPortalShot->AddClassnameToIgnore( "prop_vehicle_prisoner_pod" );
	traceFilterPortalShot->AddClassnameToIgnore( "prop_vehicle_passengerseat" );
	...
	traceFilterPortalShot->AddClassnameToIgnore( "item_item_crate" );
	traceFilterPortalShot->AddClassnameToIgnore( "item_healthkit" );
	traceFilterPortalShot->AddClassnameToIgnore( "item_healthkit_small" );
	traceFilterPortalShot->AddClassnameToIgnore( "item_healthkit_medium" );
	traceFilterPortalShot->AddClassnameToIgnore( "item_healthkit_large" );
	traceFilterPortalShot->AddClassnameToIgnore( "item_ammopack_small" );
	traceFilterPortalShot->AddClassnameToIgnore( "item_ammopack_medium" );
	traceFilterPortalShot->AddClassnameToIgnore( "item_ammopack_large" );
	traceFilterPortalShot->AddClassnameToIgnore( "item_teamflag" );
	traceFilterPortalShot->AddClassnameToIgnore( "passtime_ball" );

	traceFilterPortalShot->AddClassnameToIgnore( "headless_hatman" );
	traceFilterPortalShot->AddClassnameToIgnore( "entity_revive_marker" );

	traceFilterPortalShot->AddClassnameToIgnore( "grenade_helicopter" );
	traceFilterPortalShot->AddClassnameToIgnore( "grenade_ar2" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_grenade_frag" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_concussiongrenade" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_contactgrenade" );
	traceFilterPortalShot->AddClassnameToIgnore( "npc_handgrenade" );

	traceFilterPortalShot->AddClassnameToIgnore( "tf_projectile_pipe" );
	traceFilterPortalShot->AddClassnameToIgnore( "tf_projectile_pipe_remote" );
	traceFilterPortalShot->AddClassnameToIgnore( "tf_projectile_jar" );
	traceFilterPortalShot->AddClassnameToIgnore( "tf_projectile_jar_milk" );
	traceFilterPortalShot->AddClassnameToIgnore( "tf_projectile_jar_gas" );
	traceFilterPortalShot->AddClassnameToIgnore( "tf_projectile_stun_ball" );
#else
	traceFilterPortalShot->AddClassnameToIgnore( "class C_PhysicsProp" );
	traceFilterPortalShot->AddClassnameToIgnore( "class CPhysicsPropMultiplayer" ); // why is this the same as server?
	...
	//traceFilterPortalShot->AddClassnameToIgnore( "prop_glados_core" );
	traceFilterPortalShot->AddClassnameToIgnore( "class C_AI_BaseNPC" );
	traceFilterPortalShot->AddClassnameToIgnore( "class C_BaseGrenade" );
	traceFilterPortalShot->AddClassnameToIgnore( "class C_BaseProjectile" );
#endif // !CLIENT_DLL
							 ...
							 unsigned int mask, ITraceFilter *pFilter, trace_t *pTrace )
{
	...
	if( pEntity->IsPlayer() )
	{
		C_Prop_Portal *pPortal = ((C_TFPlayer *)pEntity)->m_hPortalEnvironment.Get();
		if( pPortal )
	...
	else
	{
		...
		{	
			...
			{
				//physcollision->TraceCollide( vecAbsStart, vecAbsEnd, pCollision, qCollisionAngles, 
				//							pPortalSimulator->m_DataAccess.Simulation.Static.World.Displacements.pCollideable, vec3_origin, vec3_angle, &tempTrace );
			...
			{
				//physcollision->TraceCollide( vecAbsStart, vecAbsEnd, pCollision, qCollisionAngles,
				//							pLinkedPortalSimulator->m_DataAccess.Simulation.Static.World.Displacements.pCollideable, pPortalSimulator->m_DataAccess.Placement.ptaap_LinkedToThis.ptOriginTransform, pPortalSimulator->m_DataAccess.Placement.ptaap_LinkedToThis.qAngleTransform, &tempTrace );
