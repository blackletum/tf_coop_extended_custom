...
public:
	...
	virtual void OnFriendlyNPCHit( CAI_BaseNPC *pNPC, CTFPlayer *pPlayer, Vector vecHitPos );
#endif
...
class CTFCSpanner : public CTFWrench
{
public:
	DECLARE_CLASS( CTFCSpanner, CTFWrench );
	DECLARE_NETWORKCLASS(); 
	DECLARE_PREDICTABLE();

 	virtual int		GetWeaponID( void ) const			{ return TF_WEAPON_TFC_SPANNER; }
};
