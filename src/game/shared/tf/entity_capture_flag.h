...
#define TF_SD_ENEMY_STOLEN			"Announcer.SD_TheirTeamHasFlag"
#define TF_SD_ENEMY_DROPPED			"Announcer.SD_TheirTeamDroppedFlag"
#define TF_SD_ENEMY_CAPTURED		"Announcer.SD_TheirTeamCapped"

#define TF_SD_RETURNED				"Announcer.SD_FlagReturned"

#define TF_SD_TEAM_STOLEN			"Announcer.SD_OurTeamHasFlag"
#define TF_SD_TEAM_DROPPED			"Announcer.SD_OurTeamDroppedFlag"
#define TF_SD_TEAM_CAPTURED			"Announcer.SD_OurTeamCapped"

//=============================================================================
//
// SD Event Flag defines.
//

#define TF_SD_2014_RED_CAPTURED			"Announcer.SD_Event_CappedBlu"
#define TF_SD_2014_BLU_CAPTURED			"Announcer.SD_Event_CappedRed"

#define TF_SD_2014_ENEMY_DROPPED		"Announcer.SD_Event_TheirTeamDroppedFlag"
#define TF_SD_2014_ENEMY_CAPTURED		"Announcer.SD_Event_TheirTeamHasFlag"

#define TF_SD_2014_RETURNED				"Announcer.SD_Event_FlagReturned"

#define TF_SD_2014_TEAM_STOLEN			"Announcer.SD_Event_OurTeamHasFlag"
#define TF_SD_2014_TEAM_DROPPED			"Announcer.SD_Event_OurTeamDroppedFlag"
...
// Game DLL Functions
	...
	void			Capture( CBaseEntity *pOwner, int nCapturePoint );
	virtual void	PickUp( CBaseEntity *pOwner, bool bInvisible );
	virtual void	Drop( CBaseEntity *pOwner, bool bVisible, bool bThrown = false, bool bMessage = true );
