...
public:
	...
	void    Teleport( const Vector *pNewOrigin, const QAngle *pNewAngles, CTFPlayer* pPlayer );
	...
	//Taunt_ComputePoseParam_MoveX( CStudioHdr * );
	//Taunt_ComputePoseParam_MoveY( CStudioHdr * );
private:
