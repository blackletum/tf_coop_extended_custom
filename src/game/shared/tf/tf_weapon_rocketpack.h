...
public:
	...
	virtual bool		CanInspect( void ) const { return false; }
	...
	void				RocketLaunchPlayer( CTFPlayer *pPlayer, const Vector& vecLaunch, bool bSomething );

	/*CalcRocketForceFromPlayer(CTFPlayer*)
	GetChargeInterval() const
