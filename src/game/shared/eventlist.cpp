...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT( AE_SCREEN_SHAKE, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_CL_HL1_WALK_LEFT, AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_CL_HL1_WALK_RIGHT, AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_CL_HL1_RUN_LEFT, AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_CL_HL1_RUN_RIGHT, AE_TYPE_CLIENT );
