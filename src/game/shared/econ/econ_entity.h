...
#ifdef CLIENT_DLL
#include "tf/c_tf_viewmodeladdon.h"
#endif
...
public:
	...
	virtual void	DrawOverriddenViewModel( C_BaseViewModel *pViewModel, int flags );
	...
	virtual bool	ShouldHideForVisionFilterFlags( void );
