...
public:
	...
	bool SetRuntimeAttributeValue( const CEconAttributeDefinition *pAttrib, const char *pszValue );
...
public:
	...
	bool RemoveAttribute( CEconItemAttribute *pAttribute );
	...
	const char*	GetVisionFilteredDisplayModel( void ) const;
