...
void FileWeaponInfo_t::Parse( KeyValues *pKeyValuesData, const char *szWeaponName )
{
	...
	Q_strncpy( szWorldModelHL1, pKeyValuesData->GetString("playermodel_hl1"), MAX_WEAPON_STRING );
	Q_strncpy( szWorldModelHL1HD, pKeyValuesData->GetString("playermodel_hl1_hd"), MAX_WEAPON_STRING );
