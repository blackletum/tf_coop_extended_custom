...
#ifdef CLIENT_DLL
				if ( pOwnerAnim && Q_stricmp( pOwnerAnim->GetMaterialOverride(), "" ) )
				{
					C_BaseAnimating *pAnimBreakable = dynamic_cast<C_BaseAnimating*>( pBreakable );
					if ( pAnimBreakable )
						pAnimBreakable->MaterialOverride( pOwnerAnim->GetMaterialOverride() );
				}
#endif
