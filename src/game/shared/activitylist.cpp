...
//HL2MP
	...
	// LFE Gravity Gun
	REGISTER_SHARED_ACTIVITY( ACT_LFE_STAND_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_CROUCH_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_DEPLOYED_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_CROUCHWALK_DEPLOYED );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_RUN_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_WALK_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_AIRWALK_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_CROUCHWALK_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_JUMP_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_JUMP_START_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_JUMP_FLOAT_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_JUMP_LAND_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_SWIM_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_SWIM_DEPLOYED_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_DOUBLEJUMP_CROUCH_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_ATTACK_STAND_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_ATTACK_STAND_PHYSGUN_DEPLOYED );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_ATTACK_CROUCH_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_ATTACK_CROUCH_PHYSGUN_DEPLOYED );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_ATTACK_SWIM_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_ATTACK_AIRWALK_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_GESTURE_FLINCH_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_GESTURE_VC_HANDMOUTH_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_GESTURE_VC_FINGERPOINT_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_GESTURE_VC_FISTPUMP_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_GESTURE_VC_THUMBSUP_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_GESTURE_VC_NODYES_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_GESTURE_VC_NODNO_PHYSGUN );

	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_HOLSTER );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_PULLBACK );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_PRIMARYATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_SECONDARYATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_DRYFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_IDLE_TO_LOWERED );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_IDLE_LOWERED );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_VM_LOWERED_TO_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_ATTACK_STAND_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_ATTACK_STAND_POSTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_ATTACK_STAND_STARTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_ATTACK_CROUCH_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_ATTACK_CROUCH_POSTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_ATTACK_SWIM_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_LFE_PHYSGUN_ATTACK_SWIM_POSTFIRE );
