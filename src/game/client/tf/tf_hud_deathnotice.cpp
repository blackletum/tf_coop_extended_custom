...
void CTFHudDeathNotice::OnGameEvent( IGameEvent *event, int iDeathNoticeMsg )
{
	...
	if ( bPlayerDeath || bIsObjectDestroyed || bNPCDeath || bFeignDeath || bFishDeath )
	{
		...
		FStrEq( "teamplay_flag_event", pszEventName ) )
	{
		...
		const char *szCaptureIcons[] = { "d_redcapture", "d_bluecapture", "d_bluecapture", "d_bluecapture" };
		const char *szDefenseIcons[] = { "d_reddefend", "d_bluedefend", "d_bluedefend", "d_bluedefend" };
