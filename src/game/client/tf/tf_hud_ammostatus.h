...
private:
	...
	vgui::ImagePanel				*m_pWeaponLowAmmoImage;
...
private:
	...
	void UpdateAmmoLabels( bool bPrimary, bool bSeconary );
...
private:
	...
	CExLabel						*m_pPrimary;
	CExLabel						*m_pPrimaryShadow;
	CExLabel						*m_pSecondary;
	CExLabel						*m_pSecondaryShadow;
