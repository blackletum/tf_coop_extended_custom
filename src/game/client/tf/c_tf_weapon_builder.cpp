...
// Purpose: 
//-----------------------------------------------------------------------------
void C_TFWeaponBuilder::ItemPostFrame( void )
{
...
void C_TFWeaponBuilder::Redraw()
{
	if ( m_iValidBuildPoseParam >= 0 )
	{
		...
		CTFViewModel *pViewModel = dynamic_cast<CTFViewModel *>( pOwner->GetViewModel( m_nViewModelIndex ) );
...
// Purpose: 
//-----------------------------------------------------------------------------
float C_TFWeaponSapper::GetChargeBeginTime( void )
{
	return 0.0f;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
float C_TFWeaponSapper::GetChargeMaxTime( void )
{
	float flTime = 15.0f;
	CTFPlayer *pPlayer = GetTFPlayerOwner();
