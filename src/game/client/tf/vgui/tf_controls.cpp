...
// Purpose: 
//-----------------------------------------------------------------------------
void CExImageButton::SetImageDefault( const char* image )
{
	Q_strncpy( m_pszImageDefaultName, image, sizeof( m_pszImageDefaultName ) );
	if ( !IsArmed() && !IsSelected() && !IsDepressed() )
		m_pSubImage->SetImage( m_pszImageDefaultName );
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CExImageButton::SetSubImage( const char* image )
{
	Q_strncpy( m_pszImageDefaultName, image, sizeof( m_pszImageDefaultName ) );
