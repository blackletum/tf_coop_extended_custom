...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTFCoOpTeamMenu::CTFCoOpTeamMenu(IViewPort *pViewPort) : CTeamMenu(pViewPort)
{
	Init();

	vgui::ivgui()->AddTickSignal(GetVPanel());
	LoadControlSettings("Resource/UI/TeamMenu_CoOp.res");
}

//-----------------------------------------------------------------------------
// Purpose: Destructor
//-----------------------------------------------------------------------------
CTFCoOpTeamMenu::~CTFCoOpTeamMenu()
{
}
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
void CTFCoOpTeamMenu::ApplySchemeSettings(IScheme *pScheme)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFCoOpTeamMenu::ShowPanel(bool bShow)
{
...
//-----------------------------------------------------------------------------
void CTFCoOpTeamMenu::Update(void)
{
	BaseClass::Update();
...
//-----------------------------------------------------------------------------
void CTFCoOpTeamMenu::LoadMapPage(const char *mapName)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFCoOpTeamMenu::OnKeyCodePressed(KeyCode code)
{
...
//-----------------------------------------------------------------------------
void CTFCoOpTeamMenu::OnCommand(const char *command)
{
...
// Intialize values
//-----------------------------------------------------------------------------
void CTFCoOpTeamMenu::Init( void )
{
