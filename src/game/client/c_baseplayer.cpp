...
void cc_firstpersonusesworldmodel( IConVar *pConVar, const char *oldValue, float flOldValue )
{
...
ConVar cl_first_person_uses_world_model( "cl_first_person_uses_world_model", "0", FCVAR_ARCHIVE, "Causes the third person model to be drawn instead of the view model", cc_firstpersonusesworldmodel );
