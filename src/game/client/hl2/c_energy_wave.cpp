...
{
	IMesh* pMesh = materials->GetRenderContext()->GetDynamicMesh( true, NULL, NULL, m_pWireframe );
...
{
	IMesh* pMesh = materials->GetRenderContext()->GetDynamicMesh( true, NULL, NULL, m_pEWaveMat );
