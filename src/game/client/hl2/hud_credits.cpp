...
void CHudCredits::PrepareCredits( const char *pKeyName )
{
	...
	if ( !pKV->LoadFromFile( filesystem, TFGameRules()->IsInHL2Map() ? CREDITS_HL2_FILE : CREDITS_BASE_FILE, "MOD" ) ||
		 !pKV->LoadFromFile( filesystem, TFGameRules()->IsInHL2EP1Map() ? CREDITS_EP1_FILE : CREDITS_BASE_FILE, "MOD" ) || 
		 !pKV->LoadFromFile( filesystem, TFGameRules()->IsInHL2EP2Map() ? CREDITS_EP2_FILE : CREDITS_BASE_FILE, "MOD" ) ||
		 !pKV->LoadFromFile( filesystem, TFGameRules()->IsInHL1Map() ? CREDITS_HLS_FILE : CREDITS_BASE_FILE, "MOD" ) )
#else
