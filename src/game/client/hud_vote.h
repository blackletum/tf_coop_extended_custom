...
extern INetworkStringTable *g_pStringTableServerMapAddFiles;
...
#endif
	void			AddVoteIssueParams_MapAddFiles( CUtlStringList &m_VoteSetupMapAddFiles );
...
#endif
	CUtlVector<const char*>	m_VoteIssuesMapAddFiles;
...
#endif
	CUtlStringList		m_VoteSetupMapAddFiles;
