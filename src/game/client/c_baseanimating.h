...
public:
	...
	void				MaterialOverride( const char *pMaterial );
	const char* 		GetMaterialOverride( void ) { return m_szMaterialOverride; }
protected:
...
private:
	...
	char				m_szMaterialOverride[MAX_PATH];
...
class C_ClientRagdoll : public C_BaseAnimating, public IPVSNotify, public CGameEventListener
{
...
inline void C_BaseAnimating::SetLightingOrigin( C_BaseEntity *pLightingOrigin )
{
	m_hLightingOrigin = pLightingOrigin;
}

inline C_BaseEntity *C_BaseAnimating::GetLightingOrigin()
{
	return m_hLightingOrigin;
}

inline void C_BaseAnimating::SetLightingOriginRelative( C_BaseEntity *pLightingOriginRelative )
{
	m_hLightingOriginRelative = pLightingOriginRelative;
}

inline C_BaseEntity *C_BaseAnimating::GetLightingOriginRelative()
{
