...
ConVar r_portal_stencil_depth( "r_portal_stencil_depth", "1", FCVAR_CLIENTDLL | FCVAR_ARCHIVE, "When using stencil views, this changes how many views within views we see" );
