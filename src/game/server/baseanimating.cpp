...
//	DEFINE_FIELD( m_BoneSetupMutex, CThreadFastMutex ),
 ...
 // DEFINE_FIELD( m_boneCacheHandle, memhandle_t ),
	...
	DEFINE_INPUTFUNC( FIELD_STRING,	"SetCustomModel",	InputSetModel ),
	...
	DEFINE_KEYFIELD( m_szMaterialOverride, FIELD_STRING, "materialoverride" ),
	DEFINE_INPUTFUNC( FIELD_STRING,	"SetMaterialOverride",	InputSetMaterialOverride ),
...
// Purpose:
//------------------------------------------------------------------------------
void CBaseAnimating::InputSetMaterialOverride( inputdata_t &inputdata )
{
	Q_snprintf( m_szMaterialOverride.GetForModify(), MAX_PATH, inputdata.value.String() );
}

//------------------------------------------------------------------------------
// Purpose:
//------------------------------------------------------------------------------
void CBaseAnimating::MaterialOverride( const char *pMaterial )
{
	Q_snprintf( m_szMaterialOverride.GetForModify(), MAX_PATH, pMaterial );
}
//=========================================================
