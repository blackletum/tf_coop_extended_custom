...
//===========================
	...
	// LFE Gravity Gun
	ADD_ACTIVITY_TO_SR( ACT_LFE_STAND_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_CROUCH_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_DEPLOYED_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_CROUCHWALK_DEPLOYED );
	ADD_ACTIVITY_TO_SR( ACT_LFE_RUN_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_WALK_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_AIRWALK_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_CROUCHWALK_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_JUMP_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_JUMP_START_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_JUMP_FLOAT_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_JUMP_LAND_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_SWIM_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_SWIM_DEPLOYED_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_DOUBLEJUMP_CROUCH_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_ATTACK_STAND_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_ATTACK_STAND_PHYSGUN_DEPLOYED );
	ADD_ACTIVITY_TO_SR( ACT_LFE_ATTACK_CROUCH_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_ATTACK_CROUCH_PHYSGUN_DEPLOYED );
	ADD_ACTIVITY_TO_SR( ACT_LFE_ATTACK_SWIM_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_ATTACK_AIRWALK_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_GESTURE_FLINCH_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_GESTURE_VC_HANDMOUTH_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_GESTURE_VC_FINGERPOINT_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_GESTURE_VC_FISTPUMP_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_GESTURE_VC_THUMBSUP_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_GESTURE_VC_NODYES_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_LFE_GESTURE_VC_NODNO_PHYSGUN );

	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_DRAW );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_HOLSTER );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_PULLBACK );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_PRIMARYATTACK );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_SECONDARYATTACK );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_DRYFIRE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_IDLE_TO_LOWERED );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_IDLE_LOWERED );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_VM_LOWERED_TO_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_ATTACK_STAND_PREFIRE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_ATTACK_STAND_POSTFIRE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_ATTACK_STAND_STARTFIRE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_ATTACK_CROUCH_PREFIRE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_ATTACK_CROUCH_POSTFIRE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_ATTACK_SWIM_PREFIRE );
	ADD_ACTIVITY_TO_SR( ACT_LFE_PHYSGUN_ATTACK_SWIM_POSTFIRE );
}
