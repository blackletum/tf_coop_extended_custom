...
ConVar sv_force_respawn_in_singleplayer("sv_force_respawn_in_singleplayer_this_is_very_unstable","0",FCVAR_CHEAT, \
	"If true force respawn in SP like in the Co-Op and DM\nTHIS IS SO UNSTABLE IT'S NOT EVEN FUNNY THIS ALMOST ALWAYS CAUSES CRASHES\n");

// called by ClientKill and DeadThink
void respawn( CBaseEntity *pEdict, bool fCopyCorpse )
{
	if (gpGlobals->coop || gpGlobals->deathmatch || sv_force_respawn_in_singleplayer.GetBool())
	{
		if ( fCopyCorpse )
		{
