...
public:
	...
	inline void LCDevMsg(int lvl, const char *msg, const char *append = NULL) { ConColorMsg(lvl, m_MsgColor, msg, append); }
	inline void LCWarning(const char *msg, const char *append = NULL) { ConColorMsg(m_WarningColor, msg, append); }
	inline void LCDevWarning(int lvl, const char *msg, const char *append = NULL) { ConColorMsg(lvl, m_WarningColor, msg, append); }
...
void CLogicEntityPosition::InputPredictPosition( inputdata_t &inputdata )
{
	...
	Vector vecPosition;
	Vector vecEntPos = GetPosition(pEntity);
	UTIL_PredictedPosition(pEntity, vecEntPos, inputdata.value.Float(), &vecPosition);
