...
void CTFGameStats::Event_AssistKill( CTFPlayer *pAttacker, CBaseEntity *pVictim )
{
	...
	TrackKillStats( pAttacker, pVictim );
}
...
{
	IncrementStat( pAttacker, TFSTAT_BONUS_POINTS, 1 );
}
...
//-----------------------------------------------------------------------------
void CTFGameStats::TrackKillStats( CBasePlayer *pAttacker, CBaseEntity *pVictim )
{
