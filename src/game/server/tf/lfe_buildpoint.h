...
//-----------------------------------------------------------------------------
class CInfoBuildPoint : public CPointEntity, public IHasBuildPoints
{
	DECLARE_CLASS( CInfoBuildPoint, CPointEntity );
public:
	DECLARE_DATADESC();

	CInfoBuildPoint( void );
...
// IHasBuildPoints
	...
	void				FireOutputs( CBaseEntity *pActivator, CBaseEntity *pObject );
	...
	void				InputDetachObject( inputdata_t &inputdata );
