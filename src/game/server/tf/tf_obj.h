...
public:
	...
	bool			CanBeBuiltOnAttachmentPoint( void ) const;
	...
	virtual int		GetMiniBuildingStartingHealth( void ) { return 50; }
	...
	void 			BuildingUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value );
...
public:
	...
	CBaseEntity			*GetParentEntity( void ) { return m_hBuiltOnEntity.Get(); };
