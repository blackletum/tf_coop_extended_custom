...
private:
	...
	COutputEvent	m_outputOnCapTeam1;	// Fired red team captured a flag on this point.
	COutputEvent	m_outputOnCapTeam2;	// Fired blue team captured a flag on this point.
