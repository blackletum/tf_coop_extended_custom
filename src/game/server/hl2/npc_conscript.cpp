...
ConVar	sk_conscript_ff_retaliation( "sk_conscript_ff_retaliation", "0" );
ConVar	sk_conscript_personality_colors( "sk_conscript_personality_colors", "0" );
...
void CNPC_Conscript::Spawn()
{
	if ( TFGameRules() && TFGameRules()->IsHL2Beta() )
    {
		...
		m_iMaxHealth = m_iHealth = sk_conscript_health.GetFloat();
