...
unsigned int CPropCombineBall::PhysicsSolidMaskForEntity( void ) const
{
	...
	default:
		uMask |= CONTENTS_REDTEAM | CONTENTS_BLUETEAM | CONTENTS_GREENTEAM | CONTENTS_YELLOWTEAM;
		break;
	}
...
// Purpose:
//-----------------------------------------------------------------------------
void CPropCombineBall::Destroy( bool bBlinkOut, bool bBreakRocket )
{
	if ( bBlinkOut )
	{
		UTIL_Remove( this );
