...
//-----------------------------------------------------------------------------
// Mapbase: Input handler for telling the func_tank to teleport an NPC to man it.
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Mapbase: Input handler for telling the func_tank to find a NPC and instantly make them man it, no matter what they're doing or where they are.
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Mapbase: Missile for func_tankrocket so kills are credited properly and don't kill friendlies
//-----------------------------------------------------------------------------
...
BEGIN_DATADESC( CFuncTankMissile )
	...
	// Function Pointers
	DEFINE_ENTITYFUNC( FTnkMissileTouch ),
