...
WeaponProficiency_t CNPC_CombineSynth::CalcWeaponProficiency( CBaseCombatWeapon *pWeapon )
{
	...
	else if ( pWeapon->GetWeaponID() == TF_WEAPON_HL2_SMG1 || pWeapon->GetWeaponID() == TF_WEAPON_HL2_SMG2 || pWeapon->GetWeaponID() == TF_WEAPON_SMG  || pWeapon->GetWeaponID() == TF_WEAPON_TFC_AUTOMATICRIFLE )
	{
		return WEAPON_PROFICIENCY_GOOD;
	}
