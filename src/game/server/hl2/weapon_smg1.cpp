...
public:
	...
	virtual int				GetWeaponID( void ) const			{ return TF_WEAPON_HL2_SMG1; }
	...
	int		WeaponRangeAttack2Condition( void );
...
void CWeaponSMG1::FireNPCPrimaryAttack( CBaseCombatCharacter *pOperator, Vector &vecShootOrigin, Vector &vecShootDir )
{
	...
	if ( lfe_hl2_weapon_use_tf_bullet.GetBool() )
	{
		...
		float flDamageMult = sk_npc_dmg_smg1.GetFloat();
...
void CWeaponSMG1::SecondaryAttack( void )
{
	...
	float flDamageMult = sk_plr_dmg_smg1_grenade.GetFloat();
	CALL_ATTRIB_HOOK_FLOAT( flDamageMult, mult_dmg );
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponSMG1::WeaponRangeAttack2Condition( void )
{
