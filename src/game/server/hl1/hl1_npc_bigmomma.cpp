...
LINK_ENTITY_TO_CLASS( npc_gonarch, CNPC_BigMomma );
...
void CNPC_BigMomma::Spawn()
{
	...
	m_iMaxHealth = m_iHealth = 150 * sk_bigmomma_health_factor.GetFloat();
	...
	switch( pEvent->event )
	{
		...
		case BIG_AE_MELEE_ATTACK1:
		{
			...
			if ( pHurt )
			{
				...
				int iDmgType = DMG_CLUB | DMG_SLASH;
				...
				CTakeDamageInfo info( this, this, 15, iDmgType );
