...
void CNPC_Headcrab::Spawn( void )
{
	...
	m_iMaxHealth = m_iHealth = sk_headcrabhl1_health.GetFloat();
...
void CNPC_Headcrab::TouchDamage( CBaseEntity *pOther )
{
	...
	CTakeDamageInfo info( this, this, GetDamageAmount(), iDmgType );
...
LINK_ENTITY_TO_CLASS( npc_headcrab_baby, CNPC_BabyCrab );
