...
void CNPC_Gargantua::Spawn()
{
	...
	m_iMaxHealth = m_iHealth = sk_gargantua_health.GetFloat();
	...
	case GARG_AE_SLASH_LEFT:
		{
			...
			// HACKHACK!!!
			CBaseEntity *pHurt = GargantuaCheckTraceHullAttack( GARG_ATTACKDIST + 10.0, sk_gargantua_dmg_slash.GetFloat(), iDmgType );
