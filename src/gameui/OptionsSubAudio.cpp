...
COptionsSubAudio::COptionsSubAudio(vgui::Panel *parent) : PropertyPage(parent, NULL)
{
   ...
   m_pMuteLoseFocus = new CCvarToggleCheckButton(this, "snd_mute_losefocus", "#GameUI_SndMuteLoseFocus", "snd_mute_losefocus");
...
void COptionsSubAudio::OnResetData()
{
   ...
   {
	  Q_strcpy( szCurrentLanguage, steamapicontext->SteamApps()->GetCurrentGameLanguage() );
	  Q_strcpy( szAvailableLanguages, steamapicontext->SteamApps()->GetAvailableGameLanguages() );
   }
#endif
