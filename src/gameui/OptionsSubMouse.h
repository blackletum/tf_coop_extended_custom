...
private:
	...
	CCvarToggleCheckButton	*m_pMouseFilterCheckBox ,*m_pMouseRawCheckbox, *m_pJoystickCheckBox,
        *m_pJoystickSouthpawCheckBox, *m_pReverseJoystickCheckBox, *m_pQuickInfoCheckBox;
