...
//-----------------------------------------------------------------------------
class CTFServerDescription : public CDescription
{
public:
	CTFServerDescription( CPanelListPanel *panel );
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CreateGameGameplayPage::CreateGameGameplayPage( vgui::Panel *parent, const char *name ) : PropertyPage( parent, name )
{
	m_pOptionsList = new CPanelListPanel( this, "GameOptions" );

	m_pDescription = new CTFServerDescription( m_pOptionsList );
	m_pDescription->InitFromFile( DEFAULT_OPTIONS_FILE );
	m_pDescription->InitFromFile( OPTIONS_FILE );
	m_pList = NULL;

	LoadControlSettings( "Resource/UI/BaseModUI/CreateGameGamePlayPage.res" );
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CreateGameGameplayPage::~CreateGameGameplayPage()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
int CreateGameGameplayPage::GetMaxPlayers()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CreateGameGameplayPage::GetPassword()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CreateGameGameplayPage::GetHostName()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CreateGameGameplayPage::GetValue(const char *cvarName, const char *defaultValue)
{
...
//-----------------------------------------------------------------------------
void CreateGameGameplayPage::OnApplyChanges()
{
...
//-----------------------------------------------------------------------------
void CreateGameGameplayPage::LoadGameOptionsList()
{
...
//-----------------------------------------------------------------------------
void CreateGameGameplayPage::GatherCurrentValues()
{
	if ( !m_pDescription )
		return;
...
//-----------------------------------------------------------------------------
CTFServerDescription::CTFServerDescription(CPanelListPanel *panel) : CDescription(panel)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFServerDescription::WriteScriptHeader( FileHandle_t fp )
{
    char am_pm[] = "AM";
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFServerDescription::WriteFileHeader( FileHandle_t fp )
{
    char am_pm[] = "AM";
