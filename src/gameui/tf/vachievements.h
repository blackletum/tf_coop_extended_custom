...
namespace BaseModUI {
	...
	private:
		...
		void SetAchievementIcon( IAchievement *pAchievement );
	...
	protected:
		enum ACHIEVEMENT_FILTER { AF_ALL, AF_COMPLETED, AF_INCOMPLETE };
		enum ACHIEVEMENT_SORT { AS_COMPLETED, AS_INCOMPLETE };
		void ApplySchemeSettings(vgui::IScheme *pScheme);
